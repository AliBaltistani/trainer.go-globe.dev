...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('program-videos.index', $program->id) }}" class="btn btn-secondary">
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('program-videos.update', [$program->id, $video->id]) }}" method="POST" enctype="multipart/form-data" id="videoForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('program-videos.index', $program->id) }}" class="btn btn-secondary">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
