...
@section('content')
    ...
    <div class="scheduling-menu-container">
        ...
        <div class="menu-grid">
            <!-- Weekly Availability -->
            <a href="{{ route('trainer.bookings.availability', ['trainer_id' => auth()->id()]) }}" class="menu-item">
            ...
            <!-- My Blocked Times -->
            <a href="{{ route('trainer.bookings.blocked-times', ['trainer_id' => auth()->id()]) }}" class="menu-item">
                <div class="menu-item-icon">
            ...
            <!-- My Session Capacity -->
            <a href="{{ route('trainer.bookings.session-capacity', ['trainer_id' => auth()->id()]) }}" class="menu-item">
                <div class="menu-item-icon">
            ...
            <!-- Booking Approval -->
            <a href="{{ route('trainer.bookings.booking-approval', ['trainer_id' => auth()->id()]) }}" class="menu-item">
                <div class="menu-item-icon">
