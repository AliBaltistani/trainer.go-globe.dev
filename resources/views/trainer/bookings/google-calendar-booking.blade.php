        ...
        <div class="col-xl-12 col-lg-12 col-md-12">
            <div class="card google-calendar-card">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <p class="mb-0 opacity-75">
                                @if(isset($booking))
                                    Update My Booking Details and sync with Google Calendar
                                @else
                ...
                <div class="card-body">
                    ...
                    <form id="googleCalendarBookingForm" action="{{ isset($booking) ? route('trainer.bookings.google-calendar.update', $booking->id) : route('trainer.bookings.google-calendar.store') }}" method="POST">
                        @csrf
                        @if(isset($booking))
                            @method('PUT')
                        ...
                        <div class="form-section">
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                    <div class="mb-3">
                                        <input type="hidden" name="trainer_id" id="trainer_id" value="{{ isset($booking) ? $booking->trainer_id : auth()->id() }}">
                                        <div class="row">
                                            <div class="col">
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            const initialTrainerId = $('#trainer_id').val();
            if (initialTrainerId) {
                checkTrainerGoogleConnection(initialTrainerId);
            }
            ...
            $('#googleCalendarBookingForm').on('submit', function(e) {
                ...
                if (!trainerId) {
                    e.preventDefault();
                    alert('Trainer not detected. Please refresh the page.');
                    return false;
                }
        ...
        function checkTrainerGoogleConnection(trainerId) {
            $.ajax({
                url: '{{ route("trainer.bookings.trainer.google-connection", ":trainerId") }}'.replace(':trainerId', trainerId),
                method: 'GET',
                headers: {
                ...
                success: function(response) {
                    ...
                    if (response.success && response.connected) {
                        ...
                        const connectUrl = '{{ route("trainer.google.connect") }}';
                        statusText.html(`
        ...
        function checkAvailability() {
            ...
            $.ajax({
                url: '{{ route("trainer.bookings.trainer.available-slots") }}',
                method: 'GET',
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
        ...
        function resetForm() {
         ...
         function confirmDelete(bookingId) {
             $('#deleteForm').attr('action', '{{ route("trainer.bookings.destroy", ":id") }}'.replace(':id', bookingId));
