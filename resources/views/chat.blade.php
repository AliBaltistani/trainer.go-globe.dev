...
<style>
    ...
    .chat-item-end .chat-item-text {
        background-color: var(--primary-color, #e6533c);
        color: #fff;
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane show active border-0 chat-users-tab" id="users-tab-pane"
                ...
                <ul class="list-unstyled mb-0 mt-2 chat-users-tab" id="chat-msg-scroll">
                    ...
                    <!-- Sample Chat Items -->
                    <li class="checkforactive" data-id="1">
                            ...
                            <div class="d-flex align-items-top">
                                ...
                                <div class="flex-fill">
                                    <p class="mb-0 fw-medium">
                                        John Doe
                                        <span class="float-end text-muted fw-normal fs-11">10:30 AM</span>
                                    </p>
                                    <p class="fs-13 mb-0">
                                        <span class="chat-msg text-truncate">Hey! How are you doing?</span>
                                    </p>
                                </div>
                            </div>
                        </a>
                    ...
                    <li class="checkforactive" data-id="2">
                        <a href="javascript:void(0);">
                            <div class="d-flex align-items-top">
                                <div class="me-1 lh-1">
                                    <span class="avatar avatar-md online me-2 avatar-rounded">
                                ...
                                <div class="flex-fill">
                                    <p class="mb-0 fw-medium">
                                        Sarah Smith
                                        <span class="float-end text-muted fw-normal fs-11">9:15 AM</span>
                                    </p>
                                    <p class="fs-13 mb-0">
                    ...
                    <li class="checkforactive" data-id="3">
                        <a href="javascript:void(0);">
                            <div class="d-flex align-items-top">
                                <div class="me-1 lh-1">
                                    <span class="avatar avatar-md online me-2 avatar-rounded">
                                ...
                                <div class="flex-fill">
                                    <p class="mb-0 fw-medium">
                                        Mike Johnson
                                        <span class="float-end text-muted fw-normal fs-11">Yesterday</span>
                                    </p>
                                    <p class="fs-13 mb-0">
                                        <span class="chat-msg text-truncate">See you tomorrow!</span>
                                    </p>
                                </div>
                            </div>
                        </a>
                        ...
                        <a href="javascript:void(0);">
                            <div class="d-flex align-items-top">
                                ...
                                <div class="flex-fill">
                                    ...
                                    <p class="fs-13 mb-0">
                                        <span class="chat-msg text-truncate">Hey! How are you doing?</span>
                                        <span class="chat-read-icon float-end align-middle badge bg-danger rounded-circle text-white" style="width: 18px; height: 18px; display: flex; align-items: center; justify-content: center; font-size: 10px;">2</span>
                                    </p>
                                </div>
                            </div>
                        </a>
                ...
                <ul class="list-unstyled mb-0 chat-contacts-tab" id="chat-contacts-scroll">
                    ...
                    <li class="checkforactive">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div class="flex-fill">
                                <span class="d-block fw-semibold">Emily Brown</span>
                            </div>
                            <div class="dropdown">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-0">
                <ul class="list-group list-group-flush">
                    <li class="list-group-item bg-light fw-bold text-uppercase fs-12 text-muted px-3 py-2">Available Contacts</li>

                    <!-- Sample Contacts -->
                    <li class="list-group-item list-group-item-action d-flex align-items-center justify-content-between p-3" style="cursor: pointer;">
                        <div class="d-flex align-items-center">
                            <span class="avatar avatar-sm avatar-rounded me-2">
                                <img src="{{asset('build/assets/images/faces/7.jpg')}}" alt="img">
                            </span>
                            <div>
                                <p class="mb-0 fw-semibold">Lisa Anderson</p>
                                <p class="fs-12 text-muted mb-0">lisa@example.com</p>
                            </div>
                        </div>
                    ...
                    <li class="list-group-item list-group-item-action d-flex align-items-center justify-content-between p-3" style="cursor: pointer;">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <p class="mb-0 fw-semibold">Tom Martinez</p>
                                <p class="fs-12 text-muted mb-0">tom@example.com</p>
                            </div>
                        </div>
                        <button class="btn btn-sm btn-icon btn-primary-light rounded-circle">
                            <i class="ri-message-2-line"></i>
